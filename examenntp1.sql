...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-12-2016 a las 18:49:22
...
INSERT INTO `persona` (`idPersona`, `iduser`, `idD`, `saldo`) VALUES
(6, 1, 3, 3.3),
(7, 2, 2, 5.25),
(8, 3, 5, 0.25),
(10, 4, 4, 0.4);
...
INSERT INTO `registro` (`idR`, `uid`, `idP`, `nombreu`) VALUES
(49, 1, 2, 'wendy'),
(50, 1, 1, 'wendy'),
(51, 1, 3, 'wendy'),
(52, 1, 1, 'wendy'),
...
--
ALTER TABLE `registro`
  MODIFY `idR` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
--
